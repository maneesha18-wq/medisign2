/**
 * Sign Language Gesture Database (SL_DB)
 * Rebranded from ISL to general Sign Language
 */
export const SL_DB = {
  hello: {
  ...
  medicine: {
    desc: "Middle finger taps palm twice — tablet/pill sign",
  ...
  default: {
    desc: "Fingerspell / approximate — word not in sign language database",
